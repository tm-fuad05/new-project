...
const WhyChooseUs = () => {
  ...
  return (
    <div className="flex flex-col gap-8 my- pt-10 pb-20 min-h-screen relative overflow-hidden">
      ...
      {/* Cards */}
      <div className="flex gap-5 px-20 z-30">
        <figure className="w-full h-[600px] card-gradient-border relative z-30">
