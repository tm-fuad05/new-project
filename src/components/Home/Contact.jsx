          ...
          <form action="" className="flex flex-col gap-6">
            ...
            <div className="relative flex gap-3">
              ...
              <input
                ...
                className="peer border-[#e5eaf2] w-[55%] dark:placeholder:text-slate-500 dark:border-slate-600 border rounded-full outline-none text-xs pl-12 pl-10 pr-4 py-3 w-full focus:border-[#3B9DF8] transition-colors duration-300"
              />
              <ArrowButton
                btnName={"Get Started"}
                arrowColor={"white"}
